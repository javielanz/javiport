...
- Out of scope for v1 unless asked: light mode, analytics, blog, CMS, server runtime, contact form, search.
- `What the next session needs to do.txt` is **stale** (points at M4; M1–M10 all shipped) — not a task list.
